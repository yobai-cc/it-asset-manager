...
> **当前版本：v1.5.1** · [下载 tar.gz](https://github.com/yobai-cc/it-asset-manager/releases/download/v1.5.1/it-asset-manager-v1.5.1.tar.gz) · [查看全部 Release](https://github.com/yobai-cc/it-asset-manager/releases)
